...
class MainControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='7']").exists())
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='7']/div/span").string("fifth"))
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='7']/div/i").string("#new one"));
    }
}
